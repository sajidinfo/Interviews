...
### 🔥 All Function Types with Example (JavaScript)

```javascript
// 1. First-Class Function
const sayHello = function() { console.log("Hello World!"); };
function greet(fn) { fn(); }
greet(sayHello); // Function ko variable me store aur pass kar rahe hain

// 2. First-Order Function
function add(a, b) { return a + b; } // Koi aur function accept/return nahi karta
console.log(add(2, 3)); 
...
function calculator(a, b, operation) { return operation(a, b); }
console.log(calculator(5, 3, add)); // Function ko parameter banaya

// 4. Pure Function
function pureSquare(n) { return n * n; }
console.log(pureSquare(4)); // Hamesha same input -> same output

// 5. Impure Function
let counter = 0;
function impure() { return ++counter; } // Global variable badal raha hai
console.log(impure()); 

// 6. Anonymous Function
setTimeout(function() { console.log("Anonymous function chal gaya"); }, 1000);

// 7. Named Function
function greetByName() { console.log("Hello Sajid!"); }
greetByName();

// 8. Arrow Function
const arrowGreet = () => console.log("Hello from Arrow!");
arrowGreet();
...
const p1 = new Person("Sajid", 25);
console.log(p1);

// 11. Factory Function
function createCar(model) {
  return { model, drive: () => console.log(model + " is driving") };
}
const car = createCar("Tesla");
car.drive();

// 12. IIFE (Immediately Invoked Function Expression)
(function() { console.log("IIFE turant run hogya"); })();
...
console.log(multiply(5)(3)); // Pehle a, phir b
...
// 16. Unary Function
function unary(x) { return x * 2; }
console.log(unary(10));

// 17. Binary Function
function binary(x, y) { return x + y; }
console.log(binary(5, 7));

// 18. Variadic Function
